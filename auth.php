...
Если да, то идём дальше, если нет, то выведем пользователю сообщение об ошибке,
 о том что он зашёл на эту страницу напрямую.
*/
if(isset($_POST["btn_submit_auth"]) && !empty($_POST["btn_submit_auth"])){
    ...
    if(isset($_POST["captcha"])){
        ...
        //Место для обработки пароля с помощью функции md5()- Будет время переписать, добавить соль
